...
class Application:
    def __init__(self):
        ...
        step = Step('first step', 'day 1', 'day 10', 9, ['Ali', 'Joe'])
        step2 = Step('second step', 'day 3', 'day 10', 7, ['Vito'])
        step3 = Step('third step', 'day 10', 'day 11', 1, ['Carlo', 'John'])
    ...
    def refresh_project(self):
        self.frame_project.grid(row=1, column=1, columnspan=6)
        ...
        for i, project in enumerate(self.projects):
            ...
            for j, step in enumerate(project.steps):
                ...
                label_duration = Label(self.frame_project, text=step.duration, width=15)
